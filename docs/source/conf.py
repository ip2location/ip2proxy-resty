...
myst_html_meta = {
    "description": "IP2Proxy OpenResty Package enables user to query an IP address if it was being used as open proxy, web proxy, VPN anonymizer and TOR exits.",
    "keywords": "IP2Proxy, Proxy, IP location, OpenResty",
...
html_title = "IP2Proxy OpenResty"

# html_baseurl = "https://ip2proxy-resty.readthedocs.io/en/latest/"